...
NOTE: Before running this program you will need to type: "make copies" in to the unix console to copy over tep's display.o file. Then type: "make miensfeld" to make the executable.
