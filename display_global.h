...
*/
extern enum Glif {TIMMY, SAFE, EMPTY, FLAG, MINE, FL_MINE, EXPLODE};
...
extern void show_glif(Glif glif, int col, int row, int Adj_count);
...
extern void update_mines(int num);
extern void update_flags(int num);
extern void update_score(int num);
...
extern void write_message(int line, char *msg);
